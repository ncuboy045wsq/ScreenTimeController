...
public class TaskUsageInfoDailyFragment extends Fragment {
    ...
    private TextView mTvScreenUsageByHour;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mTvScreenUsageByHour = view.findViewById(R.id.tv_screenUsageByHour);
    ...
    private void updateUsageInfo() {
        ...
        mTvScreenUsageByHour.setText(TimeUtils.getTaskUsageByHourDesc(Calendar.getInstance(), mTaskUsageInfosWeek));
    }
